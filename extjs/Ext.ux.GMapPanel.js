...
Ext.ux.GMapPanel = Ext.extend(Ext.Panel, {
    ...
    geoCodeLookup : function(addr) {
	    ...
	    geoCodeLookupLL: function(addr,markerTitle,markerListeners,type,custom) {
				
				this.geocoder = new GClientGeocoder();
				this.markerStreetAddr = addr;
				
				var map = this.getMap(); // Store the panel's map data in this fnc's scope...
				...
				mark.bindInfoWindowHtml(markerTitle.title + '<br>' );
				}
				}
				);
